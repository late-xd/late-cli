...
var writeFile = (0,util__WEBPACK_IMPORTED_MODULE_2__.promisify)(fs__WEBPACK_IMPORTED_MODULE_5__.writeFile);
var mainWindow;
var pdfOptions = {
  marginsType: 0,
  pageSize: 'A4',
...
function createWindow() {
  ...
  mainWindow.webContents.on('did-finish-load', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var buffer;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return mainWindow.webContents.printToPDF(pdfOptions);
